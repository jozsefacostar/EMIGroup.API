    ...
    where TResponse : IRequestResult
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Crear el RequestResult adecuado según el tipo TResponse
        ...
        if (errorResult != null)
        {
            ...
            errorResult.Module = typeof(TRequest).Name;  // Asignar el nombre del módulo basado en el tipo de request
        }

        _logger.LogWarning("Warning validación: " + JsonSerializer.Serialize(errorResult));

        // Hacer el cast de retorno correcto a TResponse
